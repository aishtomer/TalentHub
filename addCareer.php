<html>
    ...
    <?php require "conn.php";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO careerDetails(career_name, summary, more_detail, visibility, user_id) VALUES ('$career_name', '$summary', '$more_detail', '$visibility', '$user_id')";
    ...
    ?>
        ...
        <form action="" method="post" class="edit-skill-form">
            <div class="edit-skill-form">
                ...
                <input type="text" name="career_name"  id="career_name" required>
            </div>
