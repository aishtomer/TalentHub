<html>
    ...
    <?php require "conn.php";
        ...
        $award_id = $_GET['id'];
        $result = $conn->query("SELECT * FROM awardDetails WHERE award_id = $award_id");
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE awardDetails SET award_name = '$award_name', summary = '$summary', more_detail = '$more_detail', visibility = '$visibility' WHERE award_id = $award_id";
    ...
    ?>
        ...
        <form action="" method="post" class="edit-skill-form">
            <div class="edit-skill-form">
                ...
                <input type="text" name="award_name"  id="award_name" value="<?php echo $row["award_name"]; ?>" required>
            </div>
            ...
            <div class="edit-skill-form">
                <!-- Submit button to update the article -->
                <a href="deleteAward.php?id=<?php echo $row['award_id']?>">Delete</a>
            </div>
        </form>   
    </body>
</html>