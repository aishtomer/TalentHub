<html>
    ...
    <?php require "conn.php";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO educationDetails(education_name, summary, more_detail, visibility, user_id) VALUES ('$education_name', '$summary', '$more_detail', '$visibility', '$user_id')";
    ...
    ?>
        ...
        <form action="" method="post" class="edit-skill-form">
            <div class="edit-skill-form">
                ...
                <input type="text" name="education_name"  id="education_name" required>
            </div>
