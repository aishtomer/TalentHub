<html>
    ...
    <?php require "conn.php";
        ...
        $career_id = $_GET['id'];
        $result = $conn->query("SELECT * FROM careerDetails WHERE career_id = $career_id");
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE careerDetails SET career_name = '$career_name', summary = '$summary', more_detail = '$more_detail', visibility = '$visibility' WHERE career_id = $career_id";
    ...
    ?>
        ...
        <form action="" method="post" class="edit-skill-form">
            <div class="edit-skill-form">
                <label for="career_name">Career: </label>
                <!-- Input field for the title of the article -->
                <input type="text" name="career_name"  id="career_name" value="<?php echo $row["career_name"]; ?>" required>
            </div>
            ...
            <div class="edit-skill-form">
                <!-- Submit button to update the article -->
                <a href="deleteCareer.php?id=<?php echo $row['career_id']?>">Delete</a>
            </div>
        </form>   
    </body>
</html>